...
const Aside = () => {
  ...
  return (
    <>
      ...
      <aside
        className={`
          bg-gray-50 w-60 h-full flex flex-col fixed md:static top-0 left-0 z-40 transition-transform duration-300
        ...
        <div className="flex flex-col justify-center items-center text-base mt-8 w-full">
          {navigation.map((btn) => (
            <button
              ...
              className={`font-medium text-base flex items-center gap-3 h-12 w-full rounded-md px-4 transition active:bg-white ${
